...
<form action="update" method="post" enctype="multipart/form-data">
    <div class="update">
        ...
        <br>
        <label> Ảnh: </label>
        <input type="file" name="anh" style="width: auto;" >
        <br>
        <br>
        <label>Link ảnh hiện tại của sản phẩm:</label>
        <br>
        <textarea type="text" name="oldImg" readonly style="height: 50px;">${product.img}</textarea>
        <br>
        <br>
        <label>Mô tả sản phẩm: </label>
        <br>
        <textarea type="text"  name="mota" style="height: 100px;" >${product.description}</textarea>
        <br>
        <br>
