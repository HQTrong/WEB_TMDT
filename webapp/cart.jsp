  ...
  <nav class="navbar " style="background-color:white ;">
    ...
    <div class="container-fluid">
      <a class="navbar-brand">
        ...
        <img src="Image/logo.jpg" style="width:130px; height:75px;" class="img-fluid" alt="Logo">
  ...
  <div class="container">
    ...
    <c:forEach items="${cartItems}" var="sp" varStatus="status">
      <div class="row row-cols-2 row-cols-lg-3" id="row${status.index}">
        ...
        <div class="col-4 col-lg-2 text-center"><p id="gia${status.index}"><b>${sp.gia}</b></p></div>
