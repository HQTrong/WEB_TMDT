...
<body>
<div class="container-fluid" style="font-family: 'DejaVu Serif'; font-size: 50px;">
                            ...
                            <div class="card" style="width: 95%; margin-bottom: 30px;">
                                ...
                                <div class="card-body" style="background-color: gainsboro;">
                                    <center>
                                        ...
                                        <p style="font-size: 25px; color:red;"><b>${sp.gia} đồng</b></p>
                                        <button type="button" class="btn btn-warning" onclick="showNotification('${sessionScope.user}','${sp.ten}','${sp.gia}','${sp.anh}')">
