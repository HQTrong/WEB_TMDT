  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col">
        ...
        <p style=" font-size: 20px;">Bạn chưa có tài khoản? <a href="register.jsp">Đăng ký</a> </p><br>
        <p style=" font-size: 20px;">Đăng nhập với:&nbsp; <a href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
